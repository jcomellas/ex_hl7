defmodule HL7.Test.SegmentTest do
  ...
  describe "get intermediate representation from segment" do
  ...
  describe "put intermediate representation into segment" do
    test "single string field" do
      segment = %{field_name: "ABCDEF"}
      field_spec = [{:field_name, {1}, :string, 20}]
      value = "ABCDEF"
      assert ^segment = Segment.put_field_ir!(segment, field_spec, value)
    end
    ...
    test "field with multiple empty repetitions" do
      segment = %{field_name_1: "ABCDEF", field_name_2: 123_456, field_name_3: ""}
    ...
    test "field with two subcomponents in a component in a repetition each" do
      ...
      value = [{{"ABCDEF", "123456"}}, {{"GHIJKL", "789012"}}]
      assert ^segment = Segment.put_field_ir!(segment, field_spec, value)
    end
