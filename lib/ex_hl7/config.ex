defmodule HL7.Config do
  ...
  """
  def field_sep, do: Application.get_env(@otp_app, :field_sep) || "|"
  ...
  """
  def encoding_chars, do: Application.get_env(@otp_app, :encoding_chars) || "^~\\&"

  @doc """
  Returns the processing ID used by default in the **MSH** HL7 segment. Set it in `mix.exs` as
  `P` for production and `D` for debugging:

      config :ex_hl7, processing_id: "P"

  """
  def processing_id, do: Application.get_env(@otp_app, :processing_id) || "P"
  ...
  """
  def version, do: Application.get_env(@otp_app, :version) || "2.4"

  @doc """
  Returns the country code used by default in the **MSH** HL7 segment. Set it in `mix.exs` as the
  corresponding 3-letter ISO code:

      config :ex_hl7, country_code: "ARG"

  """
  def country_code, do: Application.get_env(@otp_app, :country_code) || "ARG"
end
